...
Controller = ($timeout, $element, $scope, rdInputEVENTS, $attrs) ->
  ctrl = @
  ctrl.form = {
    value: null
  }
...
Controller.$inject = ['$timeout', '$element', '$scope', 'rdInputEVENTS', '$attrs']
...
angular.module('rdForms').component 'rdInput', {
  bindings: {
    autofocus: '<'
    hint: '@'
