(function() {
  ...
  template = '<button class="btn btn-primary" type="submit" ng-disabled="$ctrl.isActive( $ctrl.id )" ng-class="$ctrl.buttonClass"> <span class="disabled-text"> <i class="fa fa-spinner fa-spin"></i> <span ng-bind-html="$ctrl.text"></span> </span> <span class="non-disabled-text" ng-transclude></span> </button>';
